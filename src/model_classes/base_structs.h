...
//     mn_conjugate_base(arma::mat &coefficient_prior_,
//                       arma::mat &col_cov_prior_chol_,
//                       arma::mat &row_cov_chol_)
//     {
//         set_coef_prior(coefficient_prior_);
//         set_col_cov_prior(col_cov_prior_);
//         set_row_cov(row_cov_);

//         arma::uword d_cols = coefficient_prior_->.n_cols;
//         arma::uword d_rows = coefficient_prior_->n_rows;
...
//     {
//         marginal_mean = *data_mean + *param_prior * (*predictor);
//     }

//     void calc_marginal_cov()
//     {
//         marginal_cov = data_cov + predictor->t() *
//                                       *col_cov_prior * (*predictor);
//         marginal_cov_chol = chol(marginal_cov_chol, "lower");
//     }
...
//     arma::mat *get_marginal_mean_ptr() override {
//         return &marginal_mean
//     };

//     arma::mat *get_marginal_cov_ptr() override {
//         return &marginal_cov
//     };

//     arma::mat *get_marginal_cov_chol_ptr() override {
